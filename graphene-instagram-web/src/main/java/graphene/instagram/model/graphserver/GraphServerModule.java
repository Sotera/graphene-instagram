...
public class GraphServerModule {
	...
	public static void contributeTraversalRules(final MappedConfiguration<String, G_Constraint> rules) {
		...
		rules.add(G_CanonicalPropertyType.ADDRESS.name(), G_Constraint.REQUIRED_EQUALS);
		rules.add(G_CanonicalPropertyType.ADDRESS_STREET.name(), G_Constraint.REQUIRED_EQUALS);
		rules.add(G_CanonicalPropertyType.NAME.name(), G_Constraint.REQUIRED_EQUALS);
		rules.add(G_CanonicalPropertyType.MEDIA.name(), G_Constraint.REQUIRED_EQUALS);
