 ...
 */
@SubModule({ InstagramDAOModule.class, AppRestModule.class, GraphServerModule.class, GrapheneModule.class,
...
public class DevelopmentModule {
	...
	public static void contributeApplicationDefaults(final MappedConfiguration<String, Object> configuration) {
		configuration.add(G_SymbolConstants.APPLICATION_NAME, "Graphene-Instagram Mock");
		configuration.add(G_SymbolConstants.APPLICATION_CONTACT, "Instagram");
		configuration.add(SymbolConstants.APPLICATION_VERSION, "${graphene.application-version}-DEV");
	}
