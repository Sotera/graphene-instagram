...
@PluginPage(visualType = G_VisualType.EXPERIMENTAL, menuName = "Hyper Graph", icon = "fa fa-lg fa-fw fa-code-fork")
public class CytoGraphTest extends SimpleBasePage {
	@Property
	...
	public JSONObject getOptions() {
		...
		JSONObject nodeCSSStyle = new JSONObject()
				...
				.put("background-color", "data(color)").put("color", "#333");
