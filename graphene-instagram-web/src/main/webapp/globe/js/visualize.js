function buildDataVizGeometries( linearData ){	
	...
	for( var i in linearData ){
		...
		console.log('Done building lines')
...
function getVisualizedMesh( linearData, year, countries, exportCategories, importCategories ){
	...
	uniforms = {
		...
		texture:   { type: "t", value: 0, texture: THREE.ImageUtils.loadTexture( "globe/images/particleA.png" ) },
	};
	...
	var particleGraphic = THREE.ImageUtils.loadTexture("globe/images/map_mask.png");
